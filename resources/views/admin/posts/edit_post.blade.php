...
@section('content')
    ...
    <div class="col-md-12">
        <div class="x_panel animate__animated animate__fadeIn">
            <div class="x_title">
                <h2><i class="fa fa-file-text"></i> Blog<small> / Editar Post</small></h2>
            ...
            <div class="x_content">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        {!! Form::text('titulo', $post->titulo, ['id' => 'titulo', 'class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        {!! Form::text('subtitulo', $post->subtitulo, ['id' => 'subtitulo', 'class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::date('fecha_publicacion', $post->fecha_publicacion, ['id' => 'fecha_publicacion', 'class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('tiempo_lectura', $post->tiempo_lectura, ['id' => 'tiempo_lectura', 'class' => 'form-control', 'min' => '1']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('contenido', $post->contenido, ['id' => 'contenido', 'class' => 'form-control']) !!}
                    </div>
                </div>
